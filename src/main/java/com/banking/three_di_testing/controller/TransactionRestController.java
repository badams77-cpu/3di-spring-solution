...
//            new Thread(() -> transactionService.makeTransfer(transactionInput));
    ...
    public ResponseEntity<?> getAllTransactions(
            @Valid @RequestBody TransactionsByDateInput transactionsByDateInput) {
        System.out.println(transactionsByDateInput);
        LOGGER.debug("Triggered TransactionRestController.postTransactionsByDate");

        if (InputValidator.isTransactionsByDateValid(transactionsByDateInput)) {
            // Attempt to retrieve the account information
            Account account = accountService.getAccount(
                    transactionsByDateInput.getSortCode(), transactionsByDateInput.getAccountNumber());
            ...
            if (account == null) {
                ...
                Account accountResult = accountService.findTransactionsBySortCodeAccountNumberAndDateBetween(transactionsByDateInput.getSortCode(), transactionsByDateInput.getAccountNumber(),
                        transactionsByDateInput.getStartDate(), transactionsByDateInput.getEndDate());
